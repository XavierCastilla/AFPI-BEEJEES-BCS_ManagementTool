...
{
    public partial class cellclip : MetroFramework.Forms.MetroForm
    {
        string text;
        public cellclip(string text2)
        {
            this.text = text2;
        ...
        private void cellclip_Load(object sender, EventArgs e)
        {
        ...
        private void timerclose_Tick(object sender, EventArgs e)
        {
            ...
            else shutdown = shutdown + 1;
        }

        private void cellclip_Leave(object sender, EventArgs e)
        {
            this.Close();
        }
    }
